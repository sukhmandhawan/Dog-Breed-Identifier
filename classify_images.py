...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        # Retrieve the pet label from the results dictionary
        pet_label = results_dic[key][0]

        # Determine if the classified label matches the actual label
        match_status = int(pet_label in model_label)

        # Update the results dictionary with the classified label and match status
        results_dic[key].extend([model_label, match_status])